    ...
    <div class="card border-0 shadow-sm mb-5">
      <div class="card-body">
        <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-3">
          ...
          <form method="post" action="<?php echo e(route('admin.reviews.summary.generate')); ?>" class="d-inline">
            <?php echo csrf_field(); ?>
        ...
        <?php if($reviewInsights): ?>
          ...
          <div class="border-top pt-3">
            <div class="mb-2">
              <span class="badge text-bg-<?php echo e($sentimentBadge); ?> text-capitalize"><?php echo e($reviewInsights['sentiment']); ?></span>
            </div>

            <p class="mb-3"><?php echo e($reviewInsights['summary']); ?></p>

            <?php if(! empty($reviewInsights['highlights'])): ?>
              <ul class="mb-3 ps-3">
                <?php $__currentLoopData = $reviewInsights['highlights']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <li class="small"><?php echo e($point); ?></li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </ul>
            <?php endif; ?>

            <p class="text-muted small mb-0">
              Based on <?php echo e($reviewInsights['review_count']); ?> review(s).
              <?php if(! empty($reviewInsights['generated_at'])): ?>
                Generated <?php echo e(\Illuminate\Support\Carbon::parse($reviewInsights['generated_at'])->diffForHumans()); ?>.
              <?php endif; ?>
            </p>
          </div>
        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\x\htdocs\sweetbite_bakery\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>